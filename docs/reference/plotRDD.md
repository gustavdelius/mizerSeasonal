...
- sim2:
  ...
  RDDs will be shown on the same plot in bolder lines.
...
- log:
  ...
  Boolean whether RDD should be plotted on a logarithmic axis. Defaults
  to true.
...
with the three variables 'Year', 'RDD', 'Species' is returned.

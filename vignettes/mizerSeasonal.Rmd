...
We can take a look at the rate $R_di$ of reproduction before density dependence and the desired rate $R_dd$ that should remain after imposing an $R_max$. Both vary throughout the year:
```{r}
...
We now set the maximum reproduction rate $R_max(t)$ so that the density-dependent reproduction $R_dd$ produced by the Beverton Holt function
$$
